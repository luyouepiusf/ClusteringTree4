...
List find_best_split_cox_bone(
  ...
  int ttidx,ii,ii2,jj,kk,oo,nn,oo1,nn1,nsplit,nsub,nfactor,splitidx,ntime;
  double ee1,tt,zscore,pvalue,chisq,a_split;
  double best_zscore=0.0,best_pvalue=1.0,best_chisq=0.0,best_split_numeric=0.0;
  int best_jj=-1,best_ngroup0=0,best_ngroup1=0;
